    ...
    <div className="shell">
      ...
      <details className="advanced" open={advancedOpen} onToggle={(event) => setAdvancedOpen(event.currentTarget.open)}>
        ...
        <div className="advanced-body">
          ...
          <div className="advanced-section">
            <div className="section-title compact"><span>04</span><div><h2>分析与测试</h2><p>低于阈值的答案会勾选并标记存疑</p></div></div>
            <div className="form-grid">
              ...
              <NumberField label="存疑置信度阈值" value={settings.confidenceThreshold} min={50} max={100} suffix="%" onChange={(value) => update("confidenceThreshold", value)} />
